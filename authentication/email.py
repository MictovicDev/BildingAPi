...
def send_linkmail(user, token):
    ...
    message = f"Thanks for Registering on bilding {user.firstname}, click the link below to verify your account, Please click the link to verify your account {url}"
